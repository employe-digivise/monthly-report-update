...
# Installs Node.js 20, PM2, and every shared library Puppeteer's bundled
# Chromium needs on Debian/Ubuntu. Idempotent: safe to re-run.
#
...
echo "==> Install Puppeteer system dependencies (Chromium runtime libs)"
apt-get install -y \
